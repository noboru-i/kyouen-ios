...
- (void)drawRect:(CGRect)rect {
    ...
    if (state_ == 1) {
        ...
        CFArrayRef colors_buffer = CFArrayCreate(kCFAllocatorDefault, (const void**)colors, 2, &kCFTypeArrayCallBacks);
        ...
        CGContextDrawRadialGradient(context, gradient, center, 0, center, width*0.3, 0);
        ...
        CGContextDrawRadialGradient(context, gradient, center, 0, center, width*2/7, 0);
