...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"TumeKyouen"
                                              withExtension:@"momd"];
    _managedObjectModel =
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory]
        URLByAppendingPathComponent:@"TumeKyouen.CDBStore"];
...
- (void)initializeData {
    ...
    NSURL *csvURL = [[NSBundle mainBundle] URLForResource:@"initial_stage"
                                            withExtension:@"csv"];
    NSString *content = [NSString stringWithContentsOfURL:csvURL
